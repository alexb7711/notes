...
:END:
The quanternion can be written as [[#Footnotes#1.md][#1]]
...
quaternion is defined as [[#Footnotes#2.md][#2]]
...
:END:
The [[file:linear_algebra.md][conjugate]] of a quaternion is analogous
...
- /2/
  [[local:docs/optimal_estimation/prelims_lectures_notes.htm.md][Optimal
